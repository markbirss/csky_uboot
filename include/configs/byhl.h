...
#define CONFIG_IDENT_STRING "BYHL 0.5"
#define DEBUG
 ...
 * (easy to change)
 */
#define CONFIG_BYHL_SERIAL

#define CONFIG_BYHL       /* This is a CSKY BYHL SoC */
...
#define CONFIG_DTB_NAME "tftpboot ${dtb_load_addr_virt} byhl_evb.dtb ; "
#else
#define CONFIG_DTB_NAME "tftpboot ${dtb_load_addr_virt} byhl.dtb ; "
#endif
...
#define CONFIG_SPL_LDSCRIPT "board/csky/byhl_evb/byhl/u-boot-spl.lds"
